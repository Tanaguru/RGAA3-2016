...
All the elements of **Set1** identified neither as informative image, nor as decorative image by marker usage (see Notes for details about detection through marker) and the aria-hidden attribute is missing.
...
All elements not identified as decorative image or informative image and have an aria-hidden attribute (All elements return false-result of **Test2**)

#### Failed

All elements identified as informative image and have an aria-hidden attribute (All elements return false-result of **Test1**)
